...
#ifndef ZEPHYR_INCLUDE_DRIVERS_FUEL_GAUGE_FUEL_GAUGE_H_
#define ZEPHYR_INCLUDE_DRIVERS_FUEL_GAUGE_FUEL_GAUGE_H_
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_FUEL_GAUGE_FUEL_GAUGE_H_ */
